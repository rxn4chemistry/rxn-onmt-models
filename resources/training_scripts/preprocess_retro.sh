...
PREPROCESSED_DATA_DIR="${THIS_DIR}/retro_preprocessed_dir"
mkdir -p ${PREPROCESSED_DATA_DIR}

onmt_preprocess \
  -train_src ${DATA_DIR}/product-train.txt \
  -train_tgt ${DATA_DIR}/precursors-train.txt \
  -valid_src ${DATA_DIR}/product-valid.txt \
  -valid_tgt ${DATA_DIR}/precursors-valid.txt \
