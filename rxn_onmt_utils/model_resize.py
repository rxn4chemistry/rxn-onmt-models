...
class ModelResizer:
    ...
    def extend_vocab(self, new_vocab_path: str):
        """Extend vocab and size of a model using a new vocab file
        s
        Args:
            new_vocab_path (str): Path to new vocab file (vocab.pt generated by ONMT)
    ...
    def _extend_field_vocab(self, new_vocab, field: str) -> List[str]:
        ...
        logger.info(f'Added {len(added_tokens)} {field} tokens:\n{added_tokens}')
