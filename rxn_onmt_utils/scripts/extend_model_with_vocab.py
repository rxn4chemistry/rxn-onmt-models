...
@click.option(
    '--vocab_path', '-v', required=True, help='Vocab for finetuning (vocab.pt generated by ONMT).'
)
@click.option('--output_path', '-o', required=True, help='Where to save the resized model.')
