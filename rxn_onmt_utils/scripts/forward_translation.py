...
@click.option(
    '--products_pred', required=True, help='Where to save the predicted products (detokenized)'
)
...
def main(
    precursors_file: str, products_tgt: Optional[str], products_pred: str, forward_model: str,
